...
public class SceneNames {
    ...
    public const string ONLINEMODE = "00-OnlineMode";
    public const string FIGHTGAME = "01-Game";
    public const string COOPERATIONGAME = "03-Game";
    public const string LEVEL = "02-Level";
    public const string LEVEL0 = "02-Level00";
