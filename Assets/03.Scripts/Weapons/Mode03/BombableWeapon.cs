...
public class BombableWeapon : ThrowWeapon {
    ...
    public override void UpgradeWeapon() {
        ...
        explosionEffect.transform.localScale = new Vector3(explosionEffect.transform.localScale.x + upgradeScale,
            explosionEffect.transform.localScale.y + upgradeScale,
            explosionEffect.transform.localScale.z + upgradeScale);
    }
